    ...
    >
      ...
      <header className="w-full max-w-6xl flex justify-between items-center bg-black/60 backdrop-blur p-4 rounded-xl border border-white/10 shadow-lg">
         ...
         <div className="text-center">
            ...
            <p className="text-gray-300 text-xs font-mono mt-1">Select your path</p>
         </div>
            ...
            >
              ...
              <div className="relative p-6 h-full flex flex-col justify-between">
                ...
                <div className="transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                  ...
                  <p className="text-yellow-400 text-sm font-retro uppercase tracking-wider mb-2 drop-shadow-md">
                    {level.sin}
                  </p>
