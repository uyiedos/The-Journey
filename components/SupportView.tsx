...
const SupportView: React.FC<SupportViewProps> = ({ user, tickets, onCreateTicket, onBack, language }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4 pt-20 md:p-8 md:pt-24 flex flex-col items-center bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] animate-fade-in">
      ...
      <div className="max-w-4xl w-full bg-gray-800 rounded-xl border-2 border-gray-600 shadow-2xl overflow-hidden flex flex-col md:flex-row h-[80vh]">
        
        {/* Sidebar */}
        <div className="w-full md:w-64 bg-black/50 p-4 border-b md:border-b-0 md:border-r border-gray-700 flex flex-col gap-2">
           <div className="mb-6">
